...
@Module({
  ...
  providers: [AppService, LoggerService, TranslateService, UploadService, AsService, AwService, AnimeiatService, JikanService, AnilistService, SaService, AfService, BlService],
})
