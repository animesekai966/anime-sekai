...
import { AnimeThemeUncheckedUpdateManyWithoutAnimesNestedInput } from '../anime-theme/anime-theme-unchecked-update-many-without-animes-nested.input';
import { AnimeDemographicUncheckedUpdateManyWithoutAnimesNestedInput } from '../anime-demographic/anime-demographic-unchecked-update-many-without-animes-nested.input';
...
export class AnimeUncheckedUpdateWithoutStudiosInput {
    ...
    @Field(() => AnimeThemeUncheckedUpdateManyWithoutAnimesNestedInput, {nullable:true})
    themes?: AnimeThemeUncheckedUpdateManyWithoutAnimesNestedInput;

    @Field(() => AnimeDemographicUncheckedUpdateManyWithoutAnimesNestedInput, {nullable:true})
    demographics?: AnimeDemographicUncheckedUpdateManyWithoutAnimesNestedInput;
}
