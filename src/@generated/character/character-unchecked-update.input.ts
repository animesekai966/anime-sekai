...
import { CharactersOnAnimesUncheckedUpdateManyWithoutCharacterNestedInput } from '../characters-on-animes/characters-on-animes-unchecked-update-many-without-character-nested.input';
...
export class CharacterUncheckedUpdateInput {
    ...
    @Field(() => CharactersOnAnimesUncheckedUpdateManyWithoutCharacterNestedInput, {nullable:true})
    animes?: CharactersOnAnimesUncheckedUpdateManyWithoutCharacterNestedInput;
}
