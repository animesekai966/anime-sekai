...
import { NestedEnumAnimeStudioTypeWithAggregatesFilter } from './nested-enum-anime-studio-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumAnimeStudioTypeFilter } from './nested-enum-anime-studio-type-filter.input';

@InputType()
export class EnumAnimeStudioTypeWithAggregatesFilter {
