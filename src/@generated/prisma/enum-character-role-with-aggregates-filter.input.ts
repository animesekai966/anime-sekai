...
import { NestedEnumCharacterRoleWithAggregatesFilter } from './nested-enum-character-role-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumCharacterRoleFilter } from './nested-enum-character-role-filter.input';

@InputType()
export class EnumCharacterRoleWithAggregatesFilter {
