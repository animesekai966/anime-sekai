...
import { NestedEnumAnimeSourceWithAggregatesFilter } from './nested-enum-anime-source-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumAnimeSourceFilter } from './nested-enum-anime-source-filter.input';

@InputType()
export class EnumAnimeSourceWithAggregatesFilter {
