...
import { CharactersOnAnimesUncheckedCreateNestedManyWithoutStaffInput } from '../characters-on-animes/characters-on-animes-unchecked-create-nested-many-without-staff.input';
...
export class StaffUncheckedCreateInput {
    ...
    @Field(() => CharactersOnAnimesUncheckedCreateNestedManyWithoutStaffInput, {nullable:true})
    animes?: CharactersOnAnimesUncheckedCreateNestedManyWithoutStaffInput;
}
